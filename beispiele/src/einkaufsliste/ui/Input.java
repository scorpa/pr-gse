...
/**
 * Hilfsklasse f�r Eingabe von Konsole
...
public class Input
{
     ...
     * Die Eingabeaufforderung wird so lange wiederholt, bis der Benutzer ein g�ltiges Datum eingibt
     * @param prompt Eingabeaufforderung
    ...
    public static Date readDate(String prompt, String format)
    {
        ...
        do
        {
            ...
            {
                System.out.println("ung�ltiges Datumsformat");
            }
        } while(date == null);
        return date;
    }
