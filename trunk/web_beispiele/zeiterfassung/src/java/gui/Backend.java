 ...
 * Backend.java
 *
 * Created on 11.03.2011, 16:06:47
 */
...
public class Backend extends javax.swing.JFrame {
    ...
    private void load()
    {
        try
        {
            for (Mitarbeiter m : zeiterfassung.mitarbeiterListe())
                mitarbeiterModel.addElement(m);
    ...
    private void neuerMitarbeiter(java.awt.event.ActionEvent evt)//GEN-FIRST:event_neuerMitarbeiter
    {//GEN-HEADEREND:event_neuerMitarbeiter
        new NeuerMitarbeiter(this, true, mitarbeiterModel, zeiterfassung).setVisible(true);
        mitarbeiterListe.validate();
    }//GEN-LAST:event_neuerMitarbeiter
